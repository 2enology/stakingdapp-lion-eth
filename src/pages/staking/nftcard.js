...
export default function NftCard({ unstakeState }) {
  return (
    <div className="border-2 border-custom rounded-3xl">
      ...
      <div className="border-custom border-t-2 flex justify-between w-full">
        {unstakeState === "unstake" ? (
          <button className="border-custom duration-150 hover:bg-green-700 p-4 rounded-b-3xl text-white w-full">
            Stake
          </button>
        ) : (
          <>
