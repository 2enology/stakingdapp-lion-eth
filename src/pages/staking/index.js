...
export default function Staking() {
  ...
  const claimAllFunc = async () => {
    ...
    await StakingContract.claimRewards(nftIDArray, { gasLimit: 300000 }).then(
      (tx) => {
        tx.wait()
          .then(() => {
            setFuncRunState(false);
          ...
          <div className="border-b-2 border-custom border-opacity-20 justify-between lg:flex w-full">
            ...
            <div className="border-custom border-t-2 flex lg:border-none">
              ...
              <div className="border-custom border-opacity-20 flex justify-center px-6 py-8 sm:border-r-2 text-center w-1/3">
                <button
                  className="bg-white duration-200 hover:bg-green-700 hover:text-white lg:px-10 lg:py-2 px-10 py-2 rounded-2xl text-sm"
                  onClick={() => unStakeAllFunc()}>
                  Unstake All
                </button>
              </div>{" "}
              <div className="border-custom border-opacity-20 flex justify-center px-6 py-8 text-center w-1/3">
                <button
                  className="bg-green-700 duration-200 hover:bg-white hover:text-black lg:px-10 lg:py-2 px-10 py-2 rounded-2xl text-sm text-white"
